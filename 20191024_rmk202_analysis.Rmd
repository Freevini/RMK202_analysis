...
threads=32
  ...
  echo ${num}"/16  :" ${names}
  num=$((num+1))
rm -r /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/${names}/spadesAssembly_meta_unmapped/assembly
mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/${names}/spadesAssembly_meta_unmapped/assembly
