...
forDensityPlot$location
# sum(is.na(forDensityPlot$location))
table(forDensityPlot$final_clust)
...
# Sterm_none_histo <- ggplot(forDensityPlot,aes(location,group=final_clust,color=final_clust,fill=final_clust))+geom_histogram(alpha=0.2)+theme_classic()+
#   scale_fill_manual(values = colors_substrains)+
#   scale_color_manual(values = colors_substrains)+
