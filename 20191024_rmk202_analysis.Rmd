...
###------------------------------------
table(explained_none_plot_nonModi_CLUSTERED$final_clust)
explained_none_plot_nonModi_CLUSTERED$final_clust = factor(explained_none_plot_nonModi_CLUSTERED$final_clust, levels=c("not clustered",6:1))
...
plotColors <- c(colorsTSNE[as.numeric(levels(explained_none_plot_nonModi_CLUSTERED$final_clust))[2:7]])
