...
scp -r vincent@130.223.51.151:/archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/IDEEL/ideel/hists/ /home/vincent/Desktop/Projects/2019_Nano_Meta/02_flye_Assembly/ideel/
...
rm -r /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/PROKKA_annotation_polishedGenome/${names}
    mkdir -p /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL/03_PROKKA_annotation_polishedGenome/${names}
    
prokka --outdir /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL/03_PROKKA_annotation_polishedGenome/${names}/ --force --usegenus --genus Streptococcus --locustag Sterm_202 --proteins proteins.faa --evalue 0.001 --addgenes /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/02_secondRacon_graphmap/assembly/secondRacon_NWC_2Assembly.fasta
#prokka --outdir /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL/03_PROKKA_annotation_polishedGenome/${names}/ --force --usegenus --genus Streptococcus --locustag Sterm_202 --proteins proteins.faa --evalue 0.001 --addgenes /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/08_fourthFreebayes/splitContigs/${names}.fasta
...
prokka --outdir /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL/03_PROKKA_annotation_polishedGenome/${names}/ --force --usegenus --genus Lactobacillus --locustag Ldel_202 --proteins proteins.faa --evalue 0.001 --addgenes /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/08_fourthFreebayes/splitContigs/${names}.fasta
...
##---------Ldel
any2fasta /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/ldel/L_delbrueckii_RMK202.current.gb > /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/ldel/L_delbrueckii_RMK202.current.fna
/usr/bin/bp_genbank2gff3 /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/ldel/L_delbrueckii_RMK202.current.gb --outdir - > /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/ldel/L_delbrueckii_RMK202.current.gff


##---------Sterm
any2fasta /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.gb > /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.fna
sudo /usr/bin/bp_genbank2gff3 /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.gb --outdir - > /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.gff


##----------------------------------------
##change name

/archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL_stiched/single/02_PGAP/vincent2/output

cat /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL_stiched/single/02_PGAP/vincent2/output/L_delbrueckii_RMK202/annot.faa > /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL_stiched/single/02_PGAP/vincent2/output/L_delbrueckii_RMK202/L_delbrueckii_RMK202_mag.faa

cat /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL_stiched/single/02_PGAP/vincent2/output/S_thermophilus_RMK202/annot.faa > /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL_stiched/single/02_PGAP/vincent2/output/S_thermophilus_RMK202/S_thermophilus_RMK202_mag.faa
...
for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/names_extended.txt)
  ...
  echo ${num}"/16  :" ${names}
  num=$((num+1))
  rm -r /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/${name_folder}/${names}
...
num=1
rm /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/${name_folder}/log/mappings.txt

#for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/names_extended.txt)
for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/onlyMeta_samples.txt)
  do
mapped=$(grep "     number of mapped reads = " /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/${name_folder}/${names}/bwaMapping2DB//bamqc/genome_results.txt  |cut -d '(' -f 2 | sed 's/%)//g')

mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/log/
echo -e ${names}"\tonlyMeta\t"${mapped} >> /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/log/mappings.txt
...
library(ggplot2)
library(readr)
mappings <- read_delim("~/Desktop/Projects/2019_Pilotplan/02_mapping2referenceDB/mappings_02.txt",  "\t", escape_double = FALSE, col_names = c("sample","type","mapping"),  trim_ws = TRUE)

median(mappings$mapping)

ggplot(mappings,aes(x=sample,y=mapping))+geom_bar(stat = "identity")+theme_classic() #+lims(y=c(90,100))
...
svg("~/Desktop/Manuscripts/2019_RMK202/Figures/20191114_draft_01/S03_mapping.svg",width=2,height=4)
...
cat /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/FINAL_assembly_withPlasmids/di_rmk202_MAG_reference_polished.fasta \
...
/archiv/Projects/2018_Culturomics/genomes/L80.fna \
/archiv/Projects/2018_Culturomics/genomes/L99.fna \
/archiv/Projects/2018_Culturomics/genomes/L71.fna \
/archiv/Projects/2018_Culturomics/genomes/L70.fna \
/archiv/Projects/2018_Culturomics/genomes/L44.fna \
/archiv/Projects/2018_Culturomics/genomes/L39.fna \
/archiv/Projects/2018_Culturomics/genomes/L35.fna \
/archiv/Projects/2018_Culturomics/genomes/L108.fna \
/archiv/Projects/2018_Culturomics/genomes/L104.fna > \
/archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/assemblyFinalwithIsolates.fasta
bwa index /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/assemblyFinalwithIsolates.fasta
...
for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/names_extended.txt)
 ...
 # bwa mem -t ${threads} /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/FINAL_assembly_withPlasmids/di_rmk202_MAG_reference_polished.fasta
  bwa mem -t ${threads} /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/assemblyFinalwithIsolates.fasta \
  /archiv/Projects/2019_pilotplant/01_rawData/02_mergedfastq/kneaddata/${names}/${names}/${names}*neaddata_paired_1.fastq /archiv/Projects/2019_pilotplant/01_rawData/02_mergedfastq/kneaddata/${names}/${names}/${names}*neaddata_paired_2.fastq | samtools sort -@${threads} -O BAM -o /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/${name_folder}/${names}/bwaMapping2DB/${names}_rawIllumina_bwamem_sorted.bam - 
...
mapped=$(grep "     number of mapped reads = " /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/${name_folder}/${names}/bwaMapping2DB//bamqc/genome_results.txt  |cut -d '(' -f 2 | sed 's/%)//g')
mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/log/
echo -e ${names}"\tallisolates\t"${mapped} >> /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/log/mappings.txt

done

scp vincent@130.223.51.116:/archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/log/mappings_02.txt Desktop/Projects/2019_Pilotplan/02_mapping2referenceDB/
##-------------------------------------------------  
##-----normal spades on unmaped
##-------------------------------------------------  
...
PrelAbundance <-  ggplot( data = all_final,aes(y = percent_coverage, x = sample, group=interaction(species),fill = species))+ geom_bar( stat="identity")+
  ...
  PrelAbundance
  svg("~/Desktop/Manuscripts/2019_RMK202/Figures/F1_relativeAbundance.svg",width=5,height=3)
   # png("~/Desktop/Manuscripts/2019_RMK202/Figures/F1_relativeAbundance.png", width = 1000, height = 800,res=300)
...
rm /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/log/multiqc_logfile_bams.txt
  #for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/names_extended.txt)
  for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/names_extended.txt)
do
...
java -jar /home/vincent/apps/picard/picard.jar AddOrReplaceReadGroups \
       I=/archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/${names}/bwaMapping2DB/${names}_rawIllumina_bwamem_sorted.bam \
       O=/archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/${names}/bwaMapping2DB/${names}_mapping2ref.bam \
       RGID=${names} \
       RGLB=lib1 \
       RGPL=illumina \
       RGPU=unit1 \
...
rm /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/log/multiqc_logfile_bams.txt

  for names in $(cat /archiv/Projects/2019_RMK202_analysis/01_log/names_extended.txt)
do

echo "/archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/"${names}"/bwaMapping2DB/"${names}"_mapping2ref.bam " >> /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/log/multiqc_logfile_bams.txt

done

##remove trailing whitespaces

 sed -i 's/[ \t]*$//' /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/log/multiqc_logfile_bams.txt
...
samtools index /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/${names}/bwaMapping2DB/${names}_mapping2ref.bam

done

##-------------calling
#rm -r /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02
#mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02


#    freebayes -F 0.05 -C 3 --min-coverage 30 --pooled-discrete \
#      --bam-list /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/log/multiqc_logfile_bams.txt -f \
#      /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/FINAL_assembly_withPlasmids/di_rmk202_MAG_reference_polished.fasta > \
#      /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02/variantCallsfreebayes_all_f_005_min_20x_again.vcf
  
  #grep "^#" -v /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02/variantCallsfreebayes_all_f_005_min_20x.vcf |cut -f 1 |sort|uniq -c
  ...
  mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02
    ...
    freebayes-parallel <(fasta_generate_regions.py /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/FINAL_assembly_withPlasmids/di_rmk202_MAG_reference_polished.fasta 100000) 36 -f /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/FINAL_assembly_withPlasmids/di_rmk202_MAG_reference_polished.fasta -C 5 --pooled-continuous --min-alternate-fraction 0.05 --min-coverage 10 --bam-list /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/log/multiqc_logfile_bams.txt > /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02/variantCallsfreebayes_minAlt3x_0.05_minCov10x.vcf
  
  
  grep "^#" -v /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02/variantCallsfreebayes_minAlt3x_0.05_minCov10x.vcf |cut -f 1 |sort|uniq -c
...
##-------------read filtering
cd /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT_02/

vcftools --vcf variantCallsfreebayes_minAlt3x_0.05_minCov10x.vcf --maf 0.05 --minQ 30 --recode --recode-INFO-all --out variantCallsfreebayes_minAlt3x_0.05_minCov10x_QC
#vcftools --vcf variantCallsfreebayes_all_f_005_min_20x.vcf --mac 3 --minQ 30 --recode --recode-INFO-all --out variantCallsfreebayes_minAlt3x_minQ30

##-------------only SNPs

vcftools --vcf /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf --remove-indels --recode --recode-INFO-all --out /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x_vcf_snpsOnly

grep "^#" -v /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x_vcf_snpsOnly.recode.vcf | cut -f 1 |sort|uniq -c


##-------------SNP density

vcftools --vcf /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf --SNPdensity 1000 --out /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x_vcf

##---------------hist-indel-len

vcftools --vcf /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf --hist-indel-len --out /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x_vcf
...
cat /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_demultiplexed/di_K2_6h/Polishing_FINAL/FINAL_assembly_withPlasmids/di_rmk202_MAG_reference_polished.fasta  > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}/sequences.fa
...
grep "^#" -v /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.gff|grep "CP0" |cut -f 1|sort|uniq -c

sed 's/CP046134/S_thermophilus_mag_rmk202/g' /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.gff | grep "^S_thermophilus_mag_rmk202" |awk -F "\t" '{OFS"\t"}{if($3=="CDS") print $0}' > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}//genes.gff

#/archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/ldel/L_delbrueckii_RMK202.current.gff
#cat /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/PGAP_assembly/sterm/S_thermophilus_RMK202.current.gff > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}//genes.gff
...
grep "S_thermophilus_mag_rmk202" /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_rmk202_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf > /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x_sterm.vcf
...
cd /home/vincent/miniconda2/share/snpeff-4.3.1t-2/
rm -r /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrain/SnpEff/${sampleShort}/
mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrain/SnpEff/${sampleShort}/


java -Xmx64g -jar snpEff.jar ${sampleShort} /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrains/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x_sterm.vcf > /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrain/SnpEff/${sampleShort}/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf 
...
grep "^##" -v /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrain/SnpEff/${sampleShort}/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf  | \
  awk -F "\t" 'BEGIN{OFS="\t"} {print $1,$2,$3,$4,$5,$6,$7,$8}' > /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata_withStrain/SnpEff/${sampleShort}/variantCallsfreebayes_all_${sampleShort}_snpEff_prepforR.vcf 
...
RMK202_snpeff_eggnog_repeats_core_uniuqes_final_reduce <- RMK202_snpeff_eggnog_repeats_core %>% select(-c("finalName","Preferred_name","EC","KEGG_ko","KEGG_Reaction","CAZy","BiGG_Reaction","COG_Functional_Category","core free text description")) %>% distinct()
...
# dev.off()
  ...
  svg("~/Desktop/Manuscripts/2019_RMK202/Figures/F1_relativeAbundance_bac_snps.svg",width=5,height=5)
   # png("~/Desktop/Manuscripts/2019_RMK202/Figures/F1_relativeAbundance.png", width = 1000, height = 800,res=300)
...
##-------------
 ...
 theme(axis.text.x = element_text(angle = 75, hjust = 1,size=9),
  ...
  pall
  svg("~/Desktop/Projects/2019_Pilotplan/02_mapping2referenceDB/05_2Phage_Bact_DB/plots/snpCalling/05_sterm_nucleotideDiv.svg",width=6,height=3)
pall
dev.off()
...
### plot 
  ...
  p3 <- ggplot(sample_relative_long_newSNPS,aes(x=sample,y=Snps,group=site,color=Preferred_name,fill=Preferred_name, text =paste("effect:", effect,"\nsignficance:",significance,"\ngeneName:",geneName,"\nRepeat_identity:",Repeat_cluster,"\ncore:",core,"\nCOG:",COG_Functional_Category)))+ geom_line(size=0.8, alpha=.5)+ 
...
### plot 
  ...
  p3 <- ggplot(sample_relative_long_fixedSNPS,aes(x=sample,y=Snps,group=site,color=Preferred_name,fill=Preferred_name, text =paste("effect:", effect,"\nsignficance:",significance,"\ngeneName:",geneName,"\nRepeat_identity:",Repeat_cluster,"\ncore:",core,"\nCOG:",COG_Functional_Category)))+ geom_line(size=0.8, alpha=.5)+ 
...
explained_mst1_plot_nonModi_CLUSTERED$final_clust = factor(explained_mst1_plot_nonModi_CLUSTERED$final_clust, levels=(sort(unique(explained_mst1_plot_nonModi_CLUSTERED$final_clust),decreasing = TRUE)))
...
explained_mst1_plot_nonModi_CLUSTERED$location <- str_split_fixed(explained_mst1_plot_nonModi_CLUSTERED$site, "_", 5)[,4]
...
explained_mst2_plot_nonModi_CLUSTERED$final_clust = factor(explained_mst2_plot_nonModi_CLUSTERED$final_clust, levels=(sort(unique(explained_mst2_plot_nonModi_CLUSTERED$final_clust),decreasing = TRUE)))
...
explained_both_plot_nonModi_CLUSTERED$final_clust = factor(explained_both_plot_nonModi_CLUSTERED$final_clust, levels=c("not clustered",4:1))
...
forDensityPlot$final_clust <- droplevels(forDensityPlot$final_clust)
forDensityPlot$final_clust = factor(forDensityPlot$final_clust, levels=c("not clustered",4:1))
plotColors <- c("grey",colorsTSNE[as.numeric(levels(forDensityPlot$final_clust))[2:5]])
...
##plotting
###------------------------------------
# explained_none_plot_nonModi_CLUSTERED
explained_none_plot_nonModi_CLUSTERED$final_clust = factor(explained_none_plot_nonModi_CLUSTERED$final_clust, levels=c("not clustered",4:1))
...
plotColors <- c("grey",colorsTSNE[as.numeric(levels(explained_none_plot_nonModi_CLUSTERED$final_clust))[2:5]])

# explained_none_plot_nonModi_CLUSTERED <- explained_none_plot_nonModi_CLUSTERED %>% filter(.,final_clust=="2")
...
explained_none_plot_nonModi_CLUSTERED$location <- str_split_fixed(explained_none_plot_nonModi_CLUSTERED$site, "_", 5)[,4]
