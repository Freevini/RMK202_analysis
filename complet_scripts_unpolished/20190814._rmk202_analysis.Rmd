...
rm -r /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/${name_folder}/
 ...
 # bwa mem -t ${threads} /archiv/Projects/2019_RMK202_analysis/02_flye_Assembly/merged/RMK202_merged.fasta
  bwa mem -t ${threads} /archiv/Projects/2019_RMK202_analysis/02_flye_Assembly/merged/RMK202_merged_withStrains.fasta \
...
##-------------calling
rm -r /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/freebayesOuput_WithONT
mkdir -p /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/freebayesOuput_WithONT
    ...
    freebayes -F 0.05 -C 2 --min-coverage 20 -p 1 \
      ...
      /archiv/Projects/2019_RMK202_analysis/02_flye_Assembly/merged/RMK202_merged.fasta > \
      /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf
...
scp vincent@130.223.51.151:/archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf /home/vincent/Desktop/Projects/2019_RMK202_analysis/06_snpCalling2ONT/variantCallsfreebayes_all_f_005_min_20x_withONT.vcf

grep "^##" -v /home/vincent/Desktop/Projects/2019_RMK202_analysis/06_snpCalling2ONT/variantCallsfreebayes_all_f_005_min_20x_withONT.vcf >  /home/vincent/Desktop/Projects/2019_RMK202_analysis/06_snpCalling2ONT/variantCallsfreebayes_all_preped_withONT.vcf
...
sampleShort=Streptococcus_phage
...
mkdir -p /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202
...
##--phage
cat /archiv/Projects/2019_Nano_Meta/02_flye_Assembly/02_raw_undeplexed_plasmids/1AB/Polishing_FINAL_stiched/single/fasta/single_contigs/Streptococcus_phage.fasta > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/sequences.fa
...
egrep -n -m 1 '##FASTA' /archiv/Projects/2019_pilotplant/02_annotation/rastServer/Streptococcus_phage.fasta.gbk.gff 
head -163 /archiv/Projects/2019_pilotplant/02_annotation/rastServer/Streptococcus_phage.fasta.gbk.gff |grep -v "^#"  > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes.gff

##03_build database

cd /home/vincent/miniconda2/share/snpeff-4.3.1t-2/
java -jar snpEff.jar build -gff3 -v ${sampleShort}_rmk202
...
grep "L_delbrueckii_RMK202" /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf > /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_pgap/variantCallsfreebayes_all_${sampleShort}.vcf
...
grep "^##" -v /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_pgap/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf | \
  awk -F "\t" 'BEGIN{OFS="\t"} {print $1,$2,$3,$4,$5,$6,$7,$8}' > /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_pgap/variantCallsfreebayes_all_${sampleShort}_snpEff_r.vcf
...
mkdir -p ~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/
...
scp vincent@130.223.51.151:/home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_pgap/variantCallsfreebayes_all_${sampleShort}_snpEff_r.vcf  ~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf 
...
mkdir -p /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202

grep "S_phage_RMK202_" /archiv/Projects/2019_RMK202_analysis/03_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/freebayesOuput_WithONT/variantCallsfreebayes_all_f_005_min_20x.vcf > /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}.vcf

grep -v "^#" /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}.vcf  |cut -f 1 |sort |uniq -c

##-------------run command
cd /home/vincent/miniconda2/share/snpeff-4.3.1t-2/

java -Xmx64g -jar snpEff.jar ${sampleShort}_rmk202  /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}.vcf > /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf 



grep "^##" -v /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf  | \
  awk -F "\t" 'BEGIN{OFS="\t"} {print $1,$2,$3,$4,$5,$6,$7,$8}' > /home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}_snpEff_r.vcf 


###prep for eggnog

tail -1758  /archiv/Projects/2019_pilotplant/02_annotation/rastServer/Streptococcus_phage.fasta.gbk.gff > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes.faa

awk -F "\t" 'BEGIN{OFS="\t"} {if($3=="CDS") print $0}' /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes.gff > /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.gff 

bedtools getfasta -fi /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/sequences.fa \
  -bed /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.gff \
  -fo /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.ffn

sed -i 's/:/./g' /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.ffn
transeq /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.ffn /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.faa
sed -i 's/\./:/g' /home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.faa

###move local

sampleShort=Streptococcus_phage
scp vincent@130.223.51.151:/home/vincent/Projects/2019_pilotplant/04_mapping2Nanopre/02_againstpolished_single_K1_final_kneaddata/SnpEff/${sampleShort}_rmk202/variantCallsfreebayes_all_${sampleShort}_snpEff_r.vcf  ~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_${sampleShort}_snpEff.vcf 

sampleShort=Streptococcus_phage
scp vincent@130.223.51.151:/home/vincent/miniconda2/share/snpeff-4.3.1t-2/data/${sampleShort}_rmk202/genes_cds.faa ~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_${sampleShort}_snpEff_forEggnog.faa
...
S_thermophilus_snpEff <- read_delim("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Streptococcus_thermophilus_RMK202_snpEff.vcf",  "\t", escape_double = FALSE, col_names = c("X.CHROM","POS","unknown","REF","ALT","quality","uknown2","snpeff"), trim_ws = TRUE)

S_thermophilus_snpEff_02 <- subset(S_thermophilus_snpEff, select=-c(unknown,uknown2))
S_thermophilus_snpEff_02$site <- paste(S_thermophilus_snpEff_02$X.CHROM,S_thermophilus_snpEff_02$POS,S_thermophilus_snpEff_02$REF,S_thermophilus_snpEff_02$ALT,sep="_")

sterm_snpeff <-  data.frame(str_split_fixed(S_thermophilus_snpEff_02$snpeff, fixed("|"), 136)[,2:8])
colnames(sterm_snpeff) <- c("effect","significance","geneName","PGAP_name","type","typeName","typeGene")

S_thermophilus_snpEff_02 <- subset(S_thermophilus_snpEff_02, select=-snpeff)
S_thermophilus_snpEff_03 <-  cbind(S_thermophilus_snpEff_02,sterm_snpeff)
...
S_thermophilus_snpEff_03$finalName <- S_thermophilus_snpEff_03$typeName %>% gsub("rna-","",.) %>%  gsub("TRANSCRIPT_gene-","",.) #%>%  gsub("pgaptmp_","pgaptmp ",.) 
length(grep("pgaptmp_",S_thermophilus_snpEff_03$finalName,invert = TRUE))

##add eggnog
S_thermophilus_eggnog <- read_delim("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Streptococcus_thermophilus_RMK202_eggnog.vcf",  "\t", escape_double = FALSE, trim_ws = TRUE,  skip = 4,col_names = c("query_name","seed_eggNOG_ortholog","seed_ortholog_evalue","seed_ortholog_score","best_tax_level","Preferred_name","GOs","EC","KEGG_ko","KEGG_Pathway","KEGG_Module","KEGG_Reaction","KEGG_rclass","BRITE","KEGG_TC","CAZy","BiGG_Reaction","tax_scope","eggNOG OGs","bestOG","COG_Functional_Category","eggNOG free text description")) %>% slice( 1:(n()-3))
S_thermophilus_eggnog$name  <- str_split_fixed(S_thermophilus_eggnog$query_name, fixed("|"), 3)[,3]
S_thermophilus_eggnog[S_thermophilus_eggnog$name %in% S_thermophilus_snpEff_03$finalName,]

##==merged
nrow(S_thermophilus_snpEff_03)
nrow(S_thermophilus_eggnog)
S_thermophilus_eggnog_snpeff <- merge(S_thermophilus_snpEff_03, S_thermophilus_eggnog, by.x = "finalName", by.y = "name",all.x = TRUE)
nrow(S_thermophilus_eggnog_snpeff)
sum(is.na(S_thermophilus_eggnog_snpeff$seed_eggNOG_ortholog))


repeats_stem <- read_delim("~/Desktop/Projects/2019_Pilotplan/09_annoation/repeatingGenes/all_repeatingGenes.txt",  "\t", escape_double = FALSE, trim_ws = TRUE,col_names = c("geneNAME","identity","cluster"))
nrow(repeats_stem)

S_thermophilus_eggnog_snpeff_02 <- merge(S_thermophilus_eggnog_snpeff, repeats_stem, by.x = "finalName", by.y = "geneNAME",all.x = TRUE)
nrow(S_thermophilus_eggnog_snpeff)
nrow(S_thermophilus_eggnog_snpeff_02)
# S_thermophilus_eggnog_snpeff$finalName
S_thermophilus_eggnog_snpeff_02[!is.na(S_thermophilus_eggnog_snpeff_02$cluster),]

write.csv(S_thermophilus_eggnog_snpeff_02,"~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Streptococcus_thermophilus_RMK202_alltogether.txt")
...
L_delbrueckii_snpEff <- read_delim("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Lactobacillus_delbrueckii_RMK202_snpEff.vcf",  "\t", escape_double = FALSE, col_names = c("X.CHROM","POS","unknown","REF","ALT","quality","uknown2","snpeff"), trim_ws = TRUE)

L_delbrueckii_snpEff_02 <- subset(L_delbrueckii_snpEff, select=-c(unknown,uknown2))
L_delbrueckii_snpEff_02$site <- paste(L_delbrueckii_snpEff_02$X.CHROM,L_delbrueckii_snpEff_02$POS,L_delbrueckii_snpEff_02$REF,L_delbrueckii_snpEff_02$ALT,sep="_")

ldel_snpeff <-  data.frame(str_split_fixed(L_delbrueckii_snpEff_02$snpeff, fixed("|"), 136)[,2:8])
colnames(ldel_snpeff) <- c("effect","significance","geneName","PGAP_name","type","typeName","typeGene")

L_delbrueckii_snpEff_02 <- subset(L_delbrueckii_snpEff_02, select=-snpeff)
L_delbrueckii_snpEff_03 <-  cbind(L_delbrueckii_snpEff_02,ldel_snpeff)
table(L_delbrueckii_snpEff_03$typeGene)

L_delbrueckii_snpEff_03[which(L_delbrueckii_snpEff_03$typeGene=="pseudogene"),]
table(L_delbrueckii_snpEff_03[which(L_delbrueckii_snpEff_03$typeGene=="protein_coding"),]$type)
L_delbrueckii_snpEff_03[which(L_delbrueckii_snpEff_03$typeGene=="rRNA"),]

L_delbrueckii_snpEff_03$finalName <- L_delbrueckii_snpEff_03$typeName %>% gsub("rna-","",.) %>%  gsub("TRANSCRIPT_gene-","",.) #%>%  gsub("pgaptmp_","pgaptmp ",.) 
length(grep("pgaptmp_",L_delbrueckii_snpEff_03$finalName,invert = TRUE))

##add eggnog
L_delbrueckii_eggnog <- read_delim("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Lactobacillus_delbrueckii_RMK202_eggnog.vcf",  "\t", escape_double = FALSE, trim_ws = TRUE,  skip = 4,col_names = c("query_name","seed_eggNOG_ortholog","seed_ortholog_evalue","seed_ortholog_score","best_tax_level","Preferred_name","GOs","EC","KEGG_ko","KEGG_Pathway","KEGG_Module","KEGG_Reaction","KEGG_rclass","BRITE","KEGG_TC","CAZy","BiGG_Reaction","tax_scope","eggNOG OGs","bestOG","COG_Functional_Category","eggNOG free text description"))%>% slice( 1:(n()-3))

L_delbrueckii_eggnog$name  <- str_split_fixed(L_delbrueckii_eggnog$query_name, fixed("|"), 3)[,3]
L_delbrueckii_eggnog[L_delbrueckii_eggnog$name %in% L_delbrueckii_snpEff_03$finalName,]

##==merged
L_delbrueckii_eggnog_snpeff <- merge(L_delbrueckii_snpEff_03, L_delbrueckii_eggnog, by.x = "finalName", by.y = "name")
sum(is.na(L_delbrueckii_eggnog_snpeff$seed_eggNOG_ortholog))



repeats_ldel <- read_delim("~/Desktop/Projects/2019_Pilotplan/09_annoation/repeatingGenes/ldel_all_repeatingGenes.txt",  "\t", escape_double = FALSE, trim_ws = TRUE,col_names = c("geneNAME","identity","cluster"))
nrow(repeats_ldel)

L_delbrueckii_eggnog_snpeff_02 <- merge(L_delbrueckii_eggnog_snpeff, repeats_ldel, by.x = "finalName", by.y = "geneNAME",all.x = TRUE)
nrow(L_delbrueckii_eggnog_snpeff)
nrow(L_delbrueckii_eggnog_snpeff_02)
# S_thermophilus_eggnog_snpeff$finalName
L_delbrueckii_eggnog_snpeff_02[!is.na(L_delbrueckii_eggnog_snpeff_02$cluster),]

write.csv(L_delbrueckii_eggnog_snpeff_02,"~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_L_delbrueckii_RMK202_alltogether.txt")
...
Sterm_phage_snpEff <- read_delim("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Streptococcus_phage_snpEff.vcf",  "\t", escape_double = FALSE, col_names = c("X.CHROM","POS","unknown","REF","ALT","quality","uknown2","snpeff"), trim_ws = TRUE)

Sterm_phage_snpEff_02 <- subset(Sterm_phage_snpEff, select=-c(unknown,uknown2))
Sterm_phage_snpEff_02$site <- paste(Sterm_phage_snpEff_02$X.CHROM,Sterm_phage_snpEff_02$POS,Sterm_phage_snpEff_02$REF,Sterm_phage_snpEff_02$ALT,sep="_")

ldel_snpeff <-  data.frame(str_split_fixed(Sterm_phage_snpEff_02$snpeff, fixed("|"), 136)[,2:8])
colnames(ldel_snpeff) <- c("effect","significance","geneName","PGAP_name","type","typeName","typeGene")

Sterm_phage_snpEff_02 <- subset(Sterm_phage_snpEff_02, select=-snpeff)
Sterm_phage_snpEff_03 <-  cbind(Sterm_phage_snpEff_02,ldel_snpeff)
table(Sterm_phage_snpEff_03$typeGene)

Sterm_phage_snpEff_03[which(Sterm_phage_snpEff_03$typeGene=="pseudogene"),]
table(Sterm_phage_snpEff_03[which(Sterm_phage_snpEff_03$typeGene=="protein_coding"),]$type)
Sterm_phage_snpEff_03[which(Sterm_phage_snpEff_03$typeGene=="rRNA"),]

Sterm_phage_snpEff_03$finalName <- Sterm_phage_snpEff_03$typeName %>% gsub("rna-","",.) %>%  gsub("TRANSCRIPT_gene-","",.) #%>%  gsub("pgaptmp_","pgaptmp ",.) 
length(grep("pgaptmp_",Sterm_phage_snpEff_03$finalName,invert = TRUE))

##add eggnog
Sterm_phage_eggnog <- read_delim("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/02_againstpolished_single_K1/gfa/AssemblyGraphs/newGenomestich/annotated/eggnog/Streptococcus_phage_query_seqs.fa.emapper.annotations",  "\t", escape_double = FALSE, trim_ws = TRUE,  skip = 4,col_names = c("query_name","seed_eggNOG_ortholog","seed_ortholog_evalue","seed_ortholog_score","best_tax_level","Preferred_name","GOs","EC","KEGG_ko","KEGG_Pathway","KEGG_Module","KEGG_Reaction","KEGG_rclass","BRITE","KEGG_TC","CAZy","BiGG_Reaction","tax_scope","eggNOG OGs","bestOG","COG_Functional_Category","eggNOG free text description"))%>% slice( 1:(n()-3))

Sterm_phage_eggnog$name  <- gsub("_1$","",Sterm_phage_eggnog$query_name) %>% gsub("-",":",.) 
tmp_1 <- str_split_fixed(Sterm_phage_eggnog$name,":",3)[,1]
tmp_2 <- as.character(as.numeric(str_split_fixed(Sterm_phage_eggnog$name,":",3)[,2])+1)
tmp_3 <- str_split_fixed(Sterm_phage_eggnog$name,":",3)[,3]
Sterm_phage_eggnog$name <- paste(tmp_1,tmp_2,tmp_3,sep=":")


Sterm_phage_snpEff_03$finalName <- gsub("TRANSCRIPT_GenBank:CDS:","",Sterm_phage_snpEff_03$finalName)
Sterm_phage_eggnog[Sterm_phage_eggnog$name %in% Sterm_phage_snpEff_03$finalName,]

##==merged
Sterm_phage_eggnog_snpeff <- merge(Sterm_phage_snpEff_03, L_delbrueckii_eggnog, by.x = "finalName", by.y = "name",all.x = TRUE)

sum(is.na(Sterm_phage_eggnog_snpeff$seed_eggNOG_ortholog))

Sterm_phage_eggnog_snpeff$identity <- NA
Sterm_phage_eggnog_snpeff$cluster <- NA

write.csv(Sterm_phage_eggnog_snpeff,"~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_S_phage_RMK202_alltogether.txt")
...
snps_freebayes_new <- read_delim("/home/vincent/Desktop/Projects/2019_RMK202_analysis/06_snpCalling2ONT/variantCallsfreebayes_all_preped_withONT.vcf", "\t", escape_double = FALSE, trim_ws = TRUE)
...
# dim(snps_freebayes)
snps_freebayes <- subset(snps_freebayes_new, select=-c(di_K1_10h,th_K1_8h))
...
# snps_freebayes[,10]
snps_freebayes_long <- gather(snps_freebayes_new, sample, Snps, colnames(snps_freebayes_new)[10]:colnames(snps_freebayes_new)[ncol(snps_freebayes_new)], factor_key=TRUE,na.rm = TRUE) 
...
# sample_relative_temp_02 <-snps_freebayes_long_cleaned %>% separate("Snps", into=c("GT","DP","AD","RO","QR","AO","QA","GL"), sep = ":") %>% transform(.,allel_frequency=as.numeric(AO))
...
sample_relative_temp <- sample_relative_temp[!sample_relative_temp$sample %in% c("di_K1_10h","th_K1_8h"),]

# sum(sample_relative_temp$sample %in% c("di_K1_10h","th_K1_8h"))
# sum(!sample_relative_temp$sample %in% c("di_K1_10h","th_K1_8h"))
...
sample_relative_long <- gather(sample_relative_wide, sample, Snps, "RMK202":"L44", factor_key=TRUE,na.rm = TRUE) 
...
```{r}
annotation_sterm <- read_csv("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_Streptococcus_thermophilus_RMK202_alltogether.txt")
annotation_ldel <- read_csv("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_L_delbrueckii_RMK202_alltogether.txt")
annotation_s_phage <- read_csv("~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/variantCallsfreebayes_all_S_phage_RMK202_alltogether.txt")
...
annotation_all <- rbind(annotation_sterm,annotation_ldel,annotation_s_phage)

nrow(sample_relative_wide)
table(sample_relative_wide$X.CHROM)
annotation_sterm_snps_wide <- merge(sample_relative_wide,annotation_all,by="site",all.x = TRUE)
nrow(annotation_sterm_snps_wide)

annotation_sterm_snps_01 <- annotation_sterm_snps_wide[(!is.na(annotation_sterm_snps_wide$effect)),]

annotation_sterm_snps_01$significance <- as.factor(annotation_sterm_snps_01$significance)
annotation_sterm_snps_01$significance <- factor(annotation_sterm_snps_01$significance, levels=c("MODIFIER","LOW","MODERATE","HIGH"))

annotation_sterm_snps_01$genome <- ifelse((annotation_sterm_snps_01$X.CHROM.x=="L_delbrueckii_RMK202"),"L_delbrueckii_RMK202",ifelse(
  (annotation_sterm_snps_01$X.CHROM.x=="S_thermophilus_RMK202"),"S_thermophilus_RMK202",ifelse(
    grep("S_phage_RMK202_",annotation_sterm_snps_01$X.CHROM.x),"S_phage_RMK202",NA
  )
))
dim(annotation_sterm_snps_01)
annotation_sterm_snps_01 <- merge(annotation_sterm_snps_01,coreGeneNames_rmk202,by="site",all.x = TRUE,all.y = FALSE)
dim(annotation_sterm_snps_01)
# table(annotation_sterm_snps_01$core)
# unique(annotation_sterm_snps_01$core)

write.csv(annotation_sterm_snps_01,"~/Desktop/Projects/2019_Pilotplan/04_mapping2ONT/SnpEff/new/SNPdata_all_extended_wide.csv")



##significance
ggplot(annotation_sterm_snps_01,aes(x=significance,fill=significance))+geom_bar()+
  theme_classic()+
  xlab("") + 
  ylab("variant sites") +
...
table(annotation_sterm_snps_high$typeGene)
ggplot(annotation_sterm_snps_high,aes(x=effect,group=typeGene))+geom_bar()+
  theme_classic()+
theme(legend.position = "none",
        plot.margin=unit(c(0,0,0,2.5),"cm"),
        axis.text.x=element_text(angle=45, hjust=1,size=9))
...
COG_functional_categories <- read_delim("~/Documents/cog_categories.csv",  "\t", escape_double = FALSE, col_names =TRUE,trim_ws = TRUE)


table(annotation_sterm_snps_01$significance)
annotation_sterm_snps_nonModifier <- annotation_sterm_snps_01[annotation_sterm_snps_01$significance!="MODIFIER",]
# table(annotation_sterm_snps_nonModifier$significance)
annotation_sterm_snps_nonModifier$COG_Functional_Category
...
annotation_sterm_snps_nonModifier_COG <- annotation_sterm_snps_nonModifier
##--------COG effect of non-modifier mutations
annotation_sterm_snps_nonModifier_COG$COG_Functional_Category <-  as.character(gsub("([a-zA-Z])([a-zA-Z])","\\1 \\2",annotation_sterm_snps_nonModifier_COG$COG_Functional_Category)) %>% gsub("([A-Z])([A-Z])","\\1 \\2",.) %>% gsub("([A-Z])([A-Z])","\\1 \\2",.) %>% gsub("([A-Z])([A-Z])","\\1 \\2",.) 
annotation_sterm_snps_nonModifier_COG_02 <- separate_rows(annotation_sterm_snps_nonModifier_COG,COG_Functional_Category,sep = " ",)
annotation_sterm_snps_nonModifier_COG_02$COG_category <- unlist(COG_functional_categories[match(annotation_sterm_snps_nonModifier_COG_02$COG_Functional_Category,COG_functional_categories$cog),2])


ggplot(annotation_sterm_snps_nonModifier_COG_02,aes(x=COG_category,group=typeGene))+geom_bar()+
  theme_classic()+
theme(legend.position = "none",
        plot.margin=unit(c(0,0,0,2.5),"cm"),
        axis.text.x=element_text(angle=45, hjust=1,size=9))
...
table(annotation_sterm_snps_nonModifier_COG_02$X.CHROM.x)
...
##remove isolates
# annotation_sterm_snps_wide
annotation_sterm_snps_long <- gather(sample_relative_wide, sample, Snps, "L44":"RMK202", factor_key=TRUE,na.rm = TRUE) 
annotation_sterm_snps_long_02 <- merge(annotation_sterm_snps_long,annotation_all,by="site",all.x = TRUE)

sample_relative_long <- annotation_sterm_snps_long_02

nrow(sample_relative_long)
sample_relative_safe_woldel <- sample_relative_long[grep("^L\\d",sample_relative_long$sample,invert = TRUE),] 
...
table(sample_relative_safe_final$X.CHROM.x)
...
sample_relative_safe_final$species <- sample_relative_safe_final$X.CHROM.x
...
table(sample_relative_safe_final$species)
...
sample_relative_safe_final_phage <- sample_relative_safe_final[grep("S_phage_RMK202",sample_relative_safe_final$species),]
table(sample_relative_safe_final_phage$species)

sample_relative_safe_final_phage[sample_relative_safe_final_phage$species=="S_phage_RMK202_33",]
sample_relative_safe_final_phage[sample_relative_safe_final_phage$species=="S_phage_RMK202_09",]


##plot
  p1 <- ggplot(sample_relative_safe_final_phage,aes(x=sample_02,y=Snps,group=site))+ geom_line(size=0.2, alpha=.1)+ 
...
# dev.off()
  ...
  library(plotly)
ggp <- ggplotly(p1)
htmlwidgets::saveWidget(ggp, "~/Desktop/Projects/2019_Pilotplan/02_mapping2referenceDB/05_2Phage_Bact_DB/plots/snpCalling/01_snpCalling_freebayes_phages.html")
...
sample_relative_safe_final <- sample_relative_safe_final[sample_relative_safe_final$species %in% c("S_thermophilus_RMK202","L_delbrueckii_RMK202"),]

##plot
  p2 <- ggplot(sample_relative_safe_final,aes(x=sample_02,y=Snps,group=site,color=species,fill=species, text =paste("effect:", effect,"\nsignficance:",significance,"\ngeneName:",geneName,"\nPreferred Name:",Preferred_name,"\nEC:",EC,"\nKEGG_ko:",KEGG_ko,"\nCAZy:",CAZy,"\nCOG:",COG_Functional_Category)))+ geom_line(size=0.2, alpha=.1)+ 
    # facet_grid(day~kessel~species)+
    facet_grid(species~.)+
    # facet_grid(treatment~species)+
    # facet_grid(treatment~species)+
...
###only in genes
   ##============
table(sample_relative_safe_final$significance)
nrow(sample_relative_safe_final)
sample_relative_safe_final_sub01 <- sample_relative_safe_final[sample_relative_safe_final$significance!="MODIFIER",]
nrow(sample_relative_safe_final_sub01)

table(sample_relative_safe_final_sub01$species)
##plot
  p3 <- ggplot(sample_relative_safe_final_sub01,aes(x=sample_02,y=Snps,group=site,color=species,fill=species, text =paste("effect:", effect,"\nsignficance:",significance,"\ngeneName:",geneName,"\nPreferred Name:",Preferred_name,"\nEC:",EC,"\nKEGG_ko:",KEGG_ko,"\nCAZy:",CAZy,"\nCOG:",COG_Functional_Category)))+ geom_line(size=0.2, alpha=.1)+ 
    # facet_grid(day~kessel~species)+
    facet_grid(species~.)+
    # facet_grid(treatment~species)+
    # facet_grid(treatment~species)+
...
nrow(sample_relative_wide)
 ...
 ##meta
sample_relative_safe_final_snps_meta <- sample_relative_wide[,c("site","Lyo_202_2012","Lyo_202_2014","Konserve_202","RMK202","Versand_202")]
...
# which(is.na(sample_relative_safe_final_meta_cleaned_02))
 ...
 ##isolates
##ldel
sample_relative_safe_final_snps_iso <- sample_relative_wide[,c("site","L99","L80","L71","L70","L108","L35","L39","L104","L44")]
# head(table(sample_relative_safe_final_snps_iso$site))
sample_relative_safe_final_snps_iso <- sample_relative_safe_final_snps_iso[grep("L_delbrueckii_RMK202_",sample_relative_safe_final_snps_iso$site),]
nrow(sample_relative_safe_final_snps_iso)
sum(rowSums(sample_relative_safe_final_snps_iso[,-1],na.rm = TRUE)==0)
hist(rowSums(sample_relative_safe_final_snps_iso[,-1]))

sample_relative_safe_final_iso_cleaned <- sample_relative_safe_final_snps_iso[(rowSums(sample_relative_safe_final_snps_iso[,-1],na.rm = TRUE)>0.9),]
# sample_relative_safe_final_iso_cleaned_test <- sample_relative_safe_final_tsne[which(rowSums(sample_relative_safe_final_snps_iso,na.rm = TRUE)>0),]
# sample_relative_safe_final_iso_cleaned==sample_relative_safe_final_iso_cleaned_test
nrow(sample_relative_safe_final_iso_cleaned)
# sample_relative_safe_final_tsne[(rowSums(sample_relative_safe_final_snps_iso,na.rm = TRUE)==0),]
sample_relative_safe_final_iso_cleaned_ldel <- sample_relative_safe_final_iso_cleaned





sample_relative_safe_final_snps_iso <- sample_relative_wide[,c("site","S72","S50")]
sample_relative_safe_final_snps_iso <- sample_relative_safe_final_snps_iso[grep("S_thermophilus_RMK202_",sample_relative_safe_final_snps_iso$site),]
nrow(sample_relative_safe_final_snps_iso)
hist(rowSums(sample_relative_safe_final_snps_iso[,-1]))
...
nrow(sample_relative_safe_final_iso_cleaned)
# sample_relative_safe_final_tsne[(rowSums(sample_relative_safe_final_snps_iso,na.rm = TRUE)==0),]
sample_relative_safe_final_iso_cleaned_sterm <- sample_relative_safe_final_iso_cleaned

##shared among two strains
sum((sample_relative_safe_final_iso_cleaned$S72>0.9 & sample_relative_safe_final_iso_cleaned$S50>0.9) %in% TRUE)
# only one strain not the other
sum((sample_relative_safe_final_iso_cleaned$S72<0.9 & sample_relative_safe_final_iso_cleaned$S50>0.9) %in% TRUE)
# only one strain not the other
sum((sample_relative_safe_final_iso_cleaned$S72>0.9 & sample_relative_safe_final_iso_cleaned$S50<0.9) %in% TRUE)
...
# onlyfirst_sterm <- sample_relative_safe_final_iso_cleaned[sample_relative_safe_final_iso_cleaned$X.CHROM=="S_thermophilus_RMK202",]

onlyfirst_sterm <- sample_relative_safe_final_iso_cleaned_sterm$site
length(onlyfirst_sterm)
...
length(onlysecond_sterm)
meta_sterm <- sample_relative_safe_final_meta_cleaned_02[sample_relative_safe_final_meta_cleaned$X.CHROM=="S_thermophilus_RMK202",]
# meta_sterm <- sample_relative_safe_final_meta_cleaned_02[sample_relative_safe_final_meta_cleaned_02$X.CHROM=="S_thermophilus_RMK202",]

both_metaIso_sterm <- meta_sterm[onlysecond_sterm %in% onlyfirst_sterm,]
both_metaIso_sterm_inIsolates <- sample_relative_safe_final_iso_cleaned_sterm[onlyfirst_sterm %in% onlysecond_sterm,]
...
onlyfirst_sterm <- sample_relative_safe_final_iso_cleaned_ldel$site
...
meta_ldel <- sample_relative_safe_final_meta_cleaned_02[sample_relative_safe_final_meta_cleaned$X.CHROM=="L_delbrueckii_RMK202",]
...
venn.plot <- draw.pairwise.venn(first_n,second_n, both_n, c("in Isolates", "in Metagenome"))
...
prep_for_dN_dS_wide <- spread(all_sterm_plot_hist, sample, allele_frequency)

prep_for_dN_dS_wide <- prep_for_dN_dS_wide[which(prep_for_dN_dS_wide$significance!="MODIFIER"),]

length(table(prep_for_dN_dS_wide$geneName))
sort(table(prep_for_dN_dS_wide$geneName),decreasing = TRUE)

table(prep_for_dN_dS_wide$significance)
gene <- "pgaptmp_001693"
...
dS 
dN 
#tmp <- data.frame(gene, "dS"=nrow(dS),"dN"=nrow(dN),"dN_dS"=(nrow(dN)+0.00001)/(nrow(dS)+0.00001))
tmp <- data.frame(gene, "dS"=nrow(dS),"dN"=nrow(dN),"dN_dS"=(nrow(dN))/(nrow(dS)+nrow(dN)))
...
sum(dN_dS_ratios$dN_dS>1)

dN_dS_ratios <- arrange(dN_dS_ratios,desc(dN_dS)) 
sum(dN_dS_ratios$dN_dS>mean(dN_dS_ratios$dN_dS))

mean(dN_dS_ratios$dN_dS)

colnames(annotation_all[11:39])
annotation_prep <- annotation_all %>% select(colnames(annotation_all[11:39]))
nrow(annotation_prep)
annotation_prep <- annotation_prep[!duplicated(annotation_prep), ]
nrow(annotation_prep)
...
#####identify highly identifical genes
...
scp vincent@130.223.51.151:/archiv/Projects/2019_pilotplant/02_annotation/CDS_clustering/splitClusters_ldel/bigCluster_ldel/all_repeatingGenes.txt ~/Desktop/Projects/2019_Pilotplan/09_annoation/repeatingGenes/ldel_all_repeatingGenes.txt
