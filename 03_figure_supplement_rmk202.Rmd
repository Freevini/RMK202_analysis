---
title: "Analysis: Functional strain redundancy and persistent phage infection in a Swiss hard cheese starter culture"
...
Here, I lock at the historical data from rmk202 received from the cheese starter culture production. 

```{r}
ph_workingStock_rmk202 <- read_delim("../data_zenodo/supplement/ph_workingStock_rmk202.csv", "\t", escape_double = FALSE, trim_ws = TRUE)
...
accesoryGenesNames <- read_csv("../data_zenodo/supplement/accesoryGenes.names",  col_names = "names")

genes_soacer <- read_delim("../data_zenodo/supplement/query_seqs.fa.emapper_accessory.annotations", "\t", escape_double = FALSE, trim_ws = TRUE, skip = 4,col_names = FALSE) %>% slice( 1:(n()-3))
...
COG_functional_categories <- read_delim("../data_zenodo/supplement/COG_functional_categories.csv",  ",", escape_double = FALSE, col_names = c("short","long","divided"),trim_ws = TRUE, na = "NA")
...
##=========================================
##---Pseudo
RMK_pseudogene <- read_delim("../data_zenodo/supplement//comparativeGenomics/pseudogene_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_contigs <- read_delim("../data_zenodo/supplement//comparativeGenomics/contigs_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_genome <- read_delim("../data_zenodo/supplement//comparativeGenomics/genome_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_genes <- read_delim("../data_zenodo/supplement//comparativeGenomics/genes_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_CRISPR <- read_delim("../data_zenodo/supplement//comparativeGenomics/CRISPR_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_ncRNAs <- read_delim("../data_zenodo/supplement//comparativeGenomics/ncRNAs_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_plasmid <- read_delim("../data_zenodo/supplement//comparativeGenomics/plasmid_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_plasmid2 <- read_delim("../data_zenodo/supplement//comparativeGenomics/plasmid3_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE) %>% dplyr::select(-LdelCov) %>% dplyr::select(-Ldelplasmid2) 
...
RMK_rRNA <- read_delim("../data_zenodo/supplement//comparativeGenomics/rRNA_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_transposase <- read_delim("../data_zenodo/supplement//comparativeGenomics/transposase_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
RMK_tRNAs <- read_delim("../data_zenodo/supplement//comparativeGenomics/tRNAs_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)

RMK_Busco <- read_delim("../data_zenodo/supplement//comparativeGenomics/Busco_RMK202.txt",  "\t", escape_double = FALSE,  trim_ws = TRUE)
...
knitr::kable(RMK_final_again, "latex", booktabs = TRUE, linesep = "") %>%
    ...
    # save_kable(file = "../data_zenodo/supplement//comparativeGenomics/table.png")
...
Lactobacillus_rRNA <- read_delim("../data_zenodo/supplement//comparativeGenomics_Ldel/rRNA/all_rRNA.txt",  "\t", escape_double = FALSE, col_names =c("genome","species","location","count"),  trim_ws = TRUE)
...
Lactobacillus_ncRNAs <- read_delim("../data_zenodo/supplement//comparativeGenomics_Ldel/ncRNAs/all_ncRNAs.txt",  "\t", escape_double = FALSE, col_names =c("genome","species","location","count"),  trim_ws = TRUE)
...
Lactobacillus_genes <- read_delim("../data_zenodo/supplement//comparativeGenomics_Ldel/genes/all_genes.txt",  "\t", escape_double = FALSE, col_names =c("genome","species","location","count"),  trim_ws = TRUE)
...
Lactobacillus_CRISPR <- read_delim("../data_zenodo/supplement//comparativeGenomics_Ldel/CRISPR/all_CRISPR.txt",  "\t", escape_double = FALSE, col_names =c("genome","species","location","count"),  trim_ws = TRUE)
...
Lactobacillus_transposase <- read_delim("../data_zenodo/supplement//comparativeGenomics_Ldel/transposase/all_transposase.txt",  "\t", escape_double = FALSE, col_names =c("genome","species","location","count"),  trim_ws = TRUE)
...
Lactobacillus_tRNAs <- read_delim("../data_zenodo/supplement//comparativeGenomics_Ldel/tRNAs/all_tRNAs.txt",  "\t", escape_double = FALSE, col_names =c("genome","species","location","count"),  trim_ws = TRUE)
...
svg("../03_results/ldelGenomes.svg",width=10,height=5)
grid.arrange(genesPlot+theme(legend.position="none"),rRNAPlot,tRNAsPlot,legend,pseudoPlot,transposasePlot,CRISPRPlot , ncol=4)
