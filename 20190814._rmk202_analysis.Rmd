...
## ===========all metagenomes in long format 
...
colnames(sample_relative_safe_final_tsne)
 ...
 sample_relative_safe_final_no_snps <- sample_relative_safe_final_tsne[,c("site","RMK202","Lyo_202_2014","S72","Lyo_202_2012","L99","L80","Versand_202","L71","L70","Konserve_202","L108","L35","S50","L39","L104","L44")]

 ##meta
sample_relative_safe_final_snps_meta <- sample_relative_safe_final_tsne[,c("site","Lyo_202_2012","Lyo_202_2014","RMK202","Konserve_202","Versand_202")]
sum(rowSums(sample_relative_safe_final_snps_meta[,-1],na.rm = TRUE)==0)
sample_relative_safe_final_meta_cleaned <- sample_relative_safe_final_tsne[(rowSums(sample_relative_safe_final_snps_meta[,-1],na.rm = TRUE)>0),]
...
which(is.na(sample_relative_safe_final_meta_cleaned_02))
sample_relative_safe_final_meta_cleaned_02[is.na(sample_relative_safe_final_meta_cleaned_02)] <- 0
which(is.na(sample_relative_safe_final_meta_cleaned_02))
...
all_final %>% 
  ...
  summarize(sum = sum(percent_coverage))  %>% 
   group_by(genus) %>% 
...
all_final %>% 
  group_by(species) %>% 
  summarize(min = min(percent_coverage),
